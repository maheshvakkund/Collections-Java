...
public class LinkedHashMapPgm {
	...
	public static void main(String[] args) {
		...
		/*
		 * The only difference between HashhMap and LinkedHashMap Is that Insertion
		 * order is preserved in LinkedHashMap and insertion order is not preserved in
		 * HashMap
		 **/

		/**
		 * 1)INSERTION IS PRESERVED IN LINKEDHASHMAP
		 * 
		 * 2)INTRODUCED IN VERSION 1.4
		 * 
		 * 3)UNDERLYING DATASTRUCTURE IS LINKEDLIST+HASHTABLE
		 */
		...
		Map<Object, Object> secondMap = new LinkedHashMap<Object, Object>();
